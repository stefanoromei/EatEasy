...
-- -----------------------------------------------------
-- Table `EatEasyDB`.`menuLine`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EatEasyDB`.`menuLine` (
  `menuLineId` INT NOT NULL AUTO_INCREMENT,
  `itemDescription` VARCHAR(45) NULL,
  `itemPrice` VARCHAR(45) NULL,
  `menuSection` VARCHAR(45) NULL,
  PRIMARY KEY (`menuLineId`))
ENGINE = InnoDB;
